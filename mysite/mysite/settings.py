...
# Use local static files (images are in Cloudinary but mapped via templates)
# Let Django's default staticfiles storage handle local files

def static(url, document_root=None):
    return []
