...
class OwnerSignupFlowTests(TestCase):
    ...
    def test_member_login_uses_registration_number_and_owner_system_record(self):
        ...
        register_response = self.client.post(
            f"/t/{tenant.subdomain}/{tenant.id}/register-member/",
            {
                "reg_number": "BCIT-001",
                "program_name": "BCIT",
                "password": "memberpass",
        ...
        self.client.post(f"/t/{tenant.subdomain}/{tenant.id}/logout/", follow=True)

        login_response = self.client.post(
            f"/t/{tenant.subdomain}/{tenant.id}/login/",
            {
        ...
        self.assertEqual(
            ...
            f"/t/{tenant.subdomain}/{tenant.id}/member-dashboard/",
        )
