...
def register_view(request, *args, **kwargs):
    ...
    Public host: owner signup is disabled. Owners must be added through the founder dashboard.
    ...
    messages.error(request, 'Owner registration is disabled. Owners must be created from the founder dashboard.')
    return _tenant_redirect(request, 'service:welcome')
