...
urlpatterns = [
    ...
    path('founder/login/', views.founder_saas_system_control, name='founder_login'),
    ...
    path('api/groups/reformat/', views.api_groups_reformat, name='api_groups_reformat'),
    path('api/groups/move-member/', views.api_group_move_member, name='api_group_move_member'),
