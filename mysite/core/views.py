...
def founder_saas_system_control(request, *args, **kwargs):
    ...
    for tenant in tenant_qs:
        ...
        tenant.owner_phone_number = owner.phone_number if owner else ''
        tenant.registration_date = owner.created_at if owner and owner.created_at else tenant.created_on
