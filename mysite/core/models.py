...
class CountdownCard(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['status', 'is_published', 'created_by', '-created_at'], name='core_cc_status_idx'),
            models.Index(fields=['created_by', '-created_at'], name='core_cc_owner_idx'),
        ]
...
class ImagePost(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['status', 'created_by', 'display_order', '-created_at'], name='core_img_status_idx'),
            models.Index(fields=['created_by', 'category'], name='core_img_owner_cat_idx'),
        ]
...
class User(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['created_by', 'is_active', '-created_at'], name='core_user_owner_active_idx'),
            models.Index(fields=['created_by', 'status'], name='core_user_owner_status_idx'),
            models.Index(fields=['created_by', 'group_name'], name='core_user_owner_group_idx'),
            models.Index(fields=['group_name', 'is_active'], name='core_user_group_active_idx'),
        ]
...
class UserGroup(models.Model):
    ...
    class Meta:
        ...
        ordering = ['group_name']
        indexes = [
            models.Index(fields=['created_by', 'is_active', 'group_name'], name='core_grp_owner_active_idx'),
            models.Index(fields=['created_by', 'is_flagged'], name='core_grp_owner_flag_idx'),
            models.Index(fields=['leader_id'], name='core_grp_leader_idx'),
        ]
...
class UserGroupMember(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['group_id', 'status', 'joined_at'], name='core_gm_group_status_idx'),
            models.Index(fields=['user_id', 'status'], name='core_gm_user_status_idx'),
            models.Index(fields=['user_id', 'group_id', 'status'], name='core_gm_user_group_status_idx'),
        ]
...
class Property(models.Model):
    ...
    claimant_contact = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['created_by', 'category', 'status', '-created_at'], name='core_prop_owner_cat_stat_idx'),
            models.Index(fields=['created_by', 'status', '-created_at'], name='core_prop_owner_status_idx'),
            models.Index(fields=['registration_number'], name='core_prop_reg_idx'),
        ]
...
class SystemSetting(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['created_by', 'setting_key'], name='core_set_owner_key_idx'),
        ]
...
class RegistrationFormField(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['created_by', 'is_active', 'display_order', 'id'], name='core_reg_owner_active_idx'),
        ]
...
class ExternalTable(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['created_by', 'is_active', 'is_visible'], name='core_ext_owner_visible_idx'),
            models.Index(fields=['created_by', 'table_name'], name='core_ext_owner_name_idx'),
        ]
